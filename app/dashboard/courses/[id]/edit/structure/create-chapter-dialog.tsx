...
export default function CreateChapterDialog({ courseId }: { courseId: string }) {
  ...
  function onSubmit(values: z.infer<typeof ChapterSchema>) {
    startTransition(async () => {
      try {
        ...
        toast('Chapter was created successfully!');
      } catch {
        toast.error('Failed to create a chapter. Please try again.');
      }
    });
  }
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="The title of new chapter" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
